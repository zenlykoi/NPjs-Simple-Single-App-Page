...
a[h][g[k].getAttribute("data")];f.removeAttribute(this.attrFor);m+=f.outerHTML}e.removeAttribute(this.attrFor)}e.outerHTML+=m}}},initTextToHTML:function(b,a,c,e){a=void 0===a?this.initElement:a;c=void 0===c?this.renderDataSymbol.open:c;e=void 0===e?this.renderDataSymbol.close:e;b=a.innerHTML;for(var d=b.split(c),f=[],g=0;g<d.length;g++)-1!=d[g].indexOf("}}")&&f.push(d[g].split(e)[0]);for(d=0;d<f.length;d++)b=b.replace(c+f[d]+e,this.getObjDataByString(f[d]));return a.innerHTML=b},getObjDataByString:function(b,
a){a=void 0===a?this.data:a;b=b.split(".");for(var c=0;c<b.length;c++)a=a[b[c]];return a},runScriptInTemplate:function(){for(var b=this.getAllElementsByAttrAndDataTag("tag",this.initElement,"script"),a=0;a<b.length;a++)eval(b[a].innerHTML),b[a].outerHTML=""},initCss:function(){for(var b=this.getAllElementsByAttrAndDataTag("tag",this.initElement,"style"),a=0;a<b.length;a++){var c=document.createElement("style");c.innerHTML=b[a].innerHTML;document.head.appendChild(c);b[a].outerHTML=""}},setDataProxy:function(){var b=
this,a={get:function(c,b){return"object"===typeof c[b]&&null!==c[b]?new Proxy(c[b],a):c[b]},set:function(a,e,d){a[e]=d;b.initTemplateByRouter();return!0}};this.dataProxy=new Proxy(this.data,a)},checkHaveRouter:function(b){for(var a=0;a<this.routes.length;a++)if(b==this.routes[a].path)return!0;return!1},renderAfterLoad:function(){var b=this;b.initEventToClickRoute();window.onload=function(){b.initTemplateByRouter()};window.onbeforeunload=function(){b.initTemplateByRouter()};window.addEventListener("popstate",
...
b;this.initElement=document.getElementById(b);this.renderAfterLoad()}};